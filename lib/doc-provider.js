...
export default class DocProvider {
  ...
  exec (arguments, callback) {
    console.log(atom.config.get('intentions-texdoc.providerPath'))
    console.log(atom.config.get('intentions-texdoc.provider'))
    ...
    childProcess.exec(`"${cmd}" ${arguments}`, { env: env }, callback)
  }
